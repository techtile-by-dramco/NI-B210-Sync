...
class test_file_save(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0_0_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/techtile/NI-B210-Sync/software/build/usrp_samples_31E2C39_1.dat', False, 0, 0)
        self.blocks_file_source_0_0_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/techtile/NI-B210-Sync/software/build/usrp_samples_31E2C39_0.dat', False, 0, 0)
        self.blocks_file_source_0_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/techtile/NI-B210-Sync/software/build/usrp_samples_31E2BD7_1.dat', False, 0, 0)
        self.blocks_file_source_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/techtile/NI-B210-Sync/software/build/usrp_samples_31E2BD7_0.dat', False, 0, 0)
        ...
        self.connect((self.blocks_complex_to_real_0_0_0_0, 0), (self.qtgui_time_sink_x_0_0, 3))
        self.connect((self.blocks_complex_to_real_0_0_1, 0), (self.qtgui_time_sink_x_0_0, 2))
        ...
        self.connect((self.blocks_file_source_0_0_0, 0), (self.low_pass_filter_0_0_0, 0))
        self.connect((self.blocks_file_source_0_0_0_0, 0), (self.low_pass_filter_0_0_1, 0))
        ...
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_complex_to_real_0_0_0, 0))
        self.connect((self.low_pass_filter_0_0_0, 0), (self.blocks_complex_to_real_0_0_1, 0))
        self.connect((self.low_pass_filter_0_0_0, 0), (self.blocks_stream_to_vector_0_0, 0))
        self.connect((self.low_pass_filter_0_0_1, 0), (self.blocks_complex_to_real_0_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 2e3, 500, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 2e3, 500, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 2e3, 500, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0_1.set_taps(firdes.low_pass(1, self.samp_rate, 2e3, 500, window.WIN_HAMMING, 6.76))
